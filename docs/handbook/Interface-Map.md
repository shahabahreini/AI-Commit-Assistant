...
Locked controls stay visible so Free users can inspect what Pro adds. Selecting a locked feature opens the purchase or activation path without silently changing configuration.
